    ...
    plans: [
      {
        ...
        aud: 150,
        usd: 99,
        description: "For couples who want full control.",
        features: [
          "Custom intake form",
          "RSVP collection",
          "SMS reminders",
      ...
      },
      {
        ...
        aud: 650,
        usd: 399,
        description: "For couples who want white-glove setup.",
        features: ["Everything in Self-serve", "We build it for you", "Copy & timing review", "Priority support"],
        cta: "Start concierge",
      },
    ],
  },
